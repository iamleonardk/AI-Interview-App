        ...
        >
          ...
          >
            ...
            <Link to="/upload" className="block">
              <motion.div
                className="glass-card hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-blue-500 bg-gradient-to-br from-white to-blue-50"
                variants={cardVariants}
                whileHover="hover"
              >
                <div className="flex items-center mb-4">
                  <motion.div
                    className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-full p-3 mr-4 shadow-lg"
            ...
            <Link to="/chat" className="block">
              <motion.div
                className="glass-card hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-green-500 bg-gradient-to-br from-white to-green-50"
                variants={cardVariants}
                whileHover="hover"
              >
                <div className="flex items-center mb-4">
                  <motion.div
                    className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-full p-3 mr-4 shadow-lg"
                    whileHover={{ rotate: 360 }}
                    transition={{ duration: 0.6 }}
                  >
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <h2 className="text-2xl font-bold text-green-600">Practice Interview</h2>
                </div>
                <p className="text-gray-600 mb-4">
          ...
          <motion.div
            ...
            variants={itemVariants}
          >
            <h2 className="text-3xl font-bold gradient-text mb-8 text-center">How It Works</h2>
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                >
                  <motion.div
                    className={`bg-gradient-to-br ${step.color} rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4 shadow-lg`}
          ...
          {/* Tips Section */}
          <motion.div
            className="glass-card bg-gradient-to-r from-blue-500 to-purple-600 text-white border-none"
            variants={itemVariants}
          >
            <h2 className="text-3xl font-bold mb-6">Interview Tips</h2>
